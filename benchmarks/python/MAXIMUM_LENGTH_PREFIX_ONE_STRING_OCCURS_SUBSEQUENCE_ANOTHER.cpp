...
static // f_filled_inner(char   param0 [ ], char   param1 [ ])
{
string string_param0(param0);
string string_param1(param1);
return (//) f_filled(string_param0,string_param1);
}
...
int main() {
    ...
    {
        if(f_filled_inner(&param0[i].front(),&param1[i].front()) == f_gold(&param0[i].front(),&param1[i].front()))
        {
            n_success+=1;
        }
    }
