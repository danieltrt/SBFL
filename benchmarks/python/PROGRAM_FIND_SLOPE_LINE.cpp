...
float f_filled ( int x1, int y1, int x2, int y2 ) {
  return ( float ) ( y2 - y1 ) / ( x2 - x1 );
}



static // f_filled_inner(float param0, float param1, float param2, float param3)
{
...
int main() {
    ...
    {
        if(abs(1 - (0.0000001 + abs(f_gold(param0[i],param1[i],param2[i],param3[i])) )/ (abs(f_filled_inner(param0[i],param1[i],param2[i],param3[i])) + 0.0000001)) < 0.001F)
        {
            n_success+=1;
        }
    }
