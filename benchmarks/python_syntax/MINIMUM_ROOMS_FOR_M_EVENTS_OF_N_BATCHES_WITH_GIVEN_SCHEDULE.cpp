...
int f_filled ( vector < vector < char >> & slots, int n, int m ) {
...
static // f_filled_inner(string   param0 [ ], int param1, int param2)
{
vector < vector < char >>  vect_param0(param0, param0 + param1);
